...
var PROGRAM_ID_BY_CLUSTER = {
  localnet: new (0, _web3js.PublicKey)("9vhgK3i91cTwTHQag85zoA3PmJUTfgvgYFc9AJPRNhGn"),
  devnet: new (0, _web3js.PublicKey)("9vhgK3i91cTwTHQag85zoA3PmJUTfgvgYFc9AJPRNhGn"),
  "mainnet-beta": new (0, _web3js.PublicKey)("REFER4ZgmyYx9c6He5XfaTMiGfdLwRnkV4RPp9t9iF3")
};
        ...
        [_spltoken.TOKEN_PROGRAM_ID, _spltoken.TOKEN_2022_PROGRAM_ID].map((programId) => __async(this, null, function* () {
          ...
          return Array.from(mintSet).map((mint) => {
            const address = this.getReferralTokenAccountPubKey({
              ...
              mint: new (0, _web3js.PublicKey)(mint)
            });
