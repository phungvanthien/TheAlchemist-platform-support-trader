...
exports.CensoWalletAdapter = exports.CensoWalletName = void 0;
const wallet_adapter_base_1 = require("@solana/wallet-adapter-base");
exports.CensoWalletName = 'Censo';
class CensoWalletAdapter extends wallet_adapter_base_1.BaseSignerWalletAdapter {
    constructor(config = {}) {
        super();
        this.name = exports.CensoWalletName;
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let CensoClass;
                try {
                    CensoClass = (yield Promise.resolve().then(() => __importStar(require('@censo-custody/solana-wallet-adapter')))).CensoWallet;
                }
                catch (error) {
